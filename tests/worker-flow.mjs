...
db.exec(`
  ...
  INSERT INTO orders VALUES('O-1','U-BUYER','S-1','PAID',10,strftime('%Y-%m-%dT%H:%M:%fZ','now','+1 hour'),NULL,CURRENT_TIMESTAMP);
  INSERT INTO tickets VALUES('T-1','O-1','U-BUYER','S-1','ACTIVE',strftime('%Y-%m-%dT%H:%M:%fZ','now','+1 hour'),NULL,CURRENT_TIMESTAMP);
