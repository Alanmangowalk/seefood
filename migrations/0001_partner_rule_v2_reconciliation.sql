...
-- Defensive cleanup in case an earlier backend candidate ever created a
...
SET
  ...
  void_reason = 'PRE_REDEEM_RULE_V2_RECONCILIATION',
...
SELECT
  ...
  (SELECT COUNT(*) FROM partner_commission_ledger WHERE void_reason = 'PRE_REDEEM_RULE_V2_RECONCILIATION') AS reconciled_pre_redeem_entries,
